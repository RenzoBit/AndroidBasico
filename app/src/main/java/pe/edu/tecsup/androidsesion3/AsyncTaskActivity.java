...
public class AsyncTaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSinHilos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(AsyncTaskActivity.this, "Tarea finalizada!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private class MiTareaAsincrona extends AsyncTask<Void, Integer, Boolean> {
        ...
        protected void onCancelled() {
            Toast.makeText(AsyncTaskActivity.this, "Tarea cancelada!", Toast.LENGTH_SHORT).show();
        }
    }
